...
//
// Every figure on this page is imported from www/atlas.lit-ui-router.dev/data/census-loop.json,
...
<code>www/atlas.lit-ui-router.dev/data/census-loop.json</code>, the checked-in plate <code>generator/census-loop.mjs</code> reads off
...
export function loopWalkedSection() {
  ...
  <div class="sheet-head"><span class="proj">${PROJECT_MARK} — INTERACTIVE PLATE</span><span class="shno">SHEET ${sheet1i.num} / ${TOTAL}</span></div>
