...
export const PLACED = [
  ...
  [35, '@tools/repo-checks',       'tools/repo-checks',                  'tool', 'pr',     449, 385, 'graph edges, task inputs, knip, patches — the lint lane waits'],
