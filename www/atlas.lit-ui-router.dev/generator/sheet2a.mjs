...
// ---- census: authored source read from www/atlas.lit-ui-router.dev/data/census-bricks.json --------
...
// data); every coupling is drawn at reading size, disengaged, so both mating faces show.
const DX = 16, DY = 9;
