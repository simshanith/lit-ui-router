...
// The data model is www/atlas.lit-ui-router.dev/data/census-loop.json's own `stations`, `legs`
...
if (!STATIONS?.length || !LEGS?.length || !WALK?.length) throw new Error('loop-walk: www/atlas.lit-ui-router.dev/data/census-loop.json carries no stations, legs or walk — re-run generator/census-loop.mjs');
