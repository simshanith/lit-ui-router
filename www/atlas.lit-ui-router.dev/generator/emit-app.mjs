...
//
// The atlas ships as ~23 standalone HTML pages. `www/atlas.lit-ui-router.dev/app/` is the same
...
// www/atlas.lit-ui-router.dev/HISTORY.md, and the log is parsed out of it at BUILD time so the app
...
// records the need — see www/atlas.lit-ui-router.dev/app/src/fragment.ts for why an inserted
    ...
    `${JSON.stringify(
      {
        ...
        date: DATE,
        base: BASE,
        generatedBy: 'www/atlas.lit-ui-router.dev/generator/emit-app.mjs',
        ...
        // every REV in www/atlas.lit-ui-router.dev/HISTORY.md, dated newest first, undated after
        issueLog,
        sheets: manifest,
