...
// Writes www/atlas.lit-ui-router.dev/data/census-files.json — provenance fields named after
...
try {
  ...
  const meta = {
    ...
    wasGeneratedBy: 'www/atlas.lit-ui-router.dev/generator/census-scc.mjs',
