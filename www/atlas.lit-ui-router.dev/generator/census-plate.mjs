...
// Writes www/atlas.lit-ui-router.dev/data/census-plate.json.
//
// Vocabulary:
...
writeData('census-plate.json', {
  ...
  wasGeneratedBy: 'www/atlas.lit-ui-router.dev/generator/census-plate.mjs',
  used: `git archive ${basis.ref} @ ${basis.sha} + pnpm install --frozen-lockfile --silent (mise-provisioned pnpm)`,
  wasAssociatedWith: [`turbo ${turboVersion}`, 'pnpm (mise-provisioned)'],
  pipelines: dump,
  graph: GRAPH_OF,
