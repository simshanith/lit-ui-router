# Deploying lit-ui-router.dev

How a push becomes a deployment of [lit-ui-router.dev](https://lit-ui-router.dev), and where each
piece of the pipeline is configured. The conventions this site shares with every other site in
[`www/`](../README.md) are described there.
