...
| `import { ... } from 'lit-ui-router/context'` | The `context-request` key, event and request helper, plus the tree-less router hand-off — see [Reactive Components](/guides/reactive-components#finding-the-router-from-anything-else). |
