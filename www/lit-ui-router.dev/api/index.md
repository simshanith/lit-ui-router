...
| `import { ... } from 'lit-ui-router/context'` | The only home of the `context-request` key, event and request helper — no elements, and nothing from `lit` — see [Reactive Components](/guides/reactive-components#router-discovery). |
