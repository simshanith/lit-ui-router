...
export class SessionStorage {
  ...
  */
  ...
  _eventEmitter = document.createElement('div');

  addEventListener = this._eventEmitter.addEventListener.bind(this._eventEmitter);
  removeEventListener = this._eventEmitter.removeEventListener.bind(this._eventEmitter);
}
