...
export class EditContact extends LitElement {
  ...
  render() {
    return html`<div class="contact">
        <sample-contact-form .contact=${this.updatedContact} @change=${this.handleChangeContact}></sample-contact-form>
        <hr />
        <div>
          <button ${uiSref('^')} class="btn btn-primary"><i class="fa fa-close"></i><span>Cancel</span></button>
          <button class="btn btn-primary" @click=${this.saveContact}><i class="fa fa-save"></i><span>Save</span></button>
          <button class="btn btn-primary" @click=${this.removeContact}><i class="fa fa-close"></i><span>Delete</span></button>
        </div>
      </div>`;
  }
}
