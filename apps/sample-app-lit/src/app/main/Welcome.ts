...
export default () => html`
  <div class="container-fluid">
    ...
    <div>
      <button ${uiSref('mymessages')} class="btn btn-primary"><i class="fa fa-envelope"></i><span>Messages</span></button>
      <button ${uiSref('contacts')} class="btn btn-primary"><i class="fa fa-users"></i><span>Contacts</span></button>
      <button ${uiSref('prefs')} class="btn btn-primary"><i class="fa fa-cogs"></i><span>Preferences</span></button>
    </div>
