...
export default () =>
  html`<div class="container-fluid">
    ...
    <p>
      ...
      be used within UI-Router. These patterns should help you to to build
    ...
    <p>
      ...
      Preferences. If you are not already logged in, you will be taken to an
      authentication screen (the authentication is fake; the password is
      "password")
    </p>
    <div>
