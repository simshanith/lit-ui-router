...
export class SessionStorage {
  ...
  constructor(sessionStorageKey, sourceUrl) {
    ...
    this._data = (
      data
        ...
        : fetch(sourceUrl).then((resp) => resp.json())
    )
      .then(this._commit)
  ...
  addEventListener = this._eventEmitter.addEventListener.bind(
    this._eventEmitter,
  );
  removeEventListener = this._eventEmitter.removeEventListener.bind(
    this._eventEmitter,
  );
}
