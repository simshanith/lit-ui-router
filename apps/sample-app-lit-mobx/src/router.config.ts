...
export function configureRouter(router = new UIRouterLit()) {
  ...
  // No store wiring needed here: components observe the router through
  // lit-ui-router-mobx's RouterReactionController, which discovers this
  // router from the <ui-router> context and lazily attaches its observable
