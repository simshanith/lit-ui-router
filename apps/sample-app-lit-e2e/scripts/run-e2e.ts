...
// Readiness paths are a property of the server, not of the selection: every app
// is mounted whichever suites run, and waiting for them all costs a probe each
