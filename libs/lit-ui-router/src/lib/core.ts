...
import { LitViewDeclaration, RoutedLitTemplate, RoutedLitElement, NormalizedLitViewDeclaration, UIViewInjectedProps } from './interface';
...
export class LitViewConfig implements ViewConfig {
  ...
  constructor(public path: PathNode[], public viewDecl: NormalizedLitViewDeclaration) {}
...
const viewConfigFactory = (path: PathNode[], config: NormalizedLitViewDeclaration) =>
