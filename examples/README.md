...
- `settings.linkElements: ['my-link']` — the app's own link element declared once for both rules that ask whether a tag is a link, with its own ✓/✗ pair in the gallery
