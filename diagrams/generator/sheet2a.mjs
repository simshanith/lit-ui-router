...
// ---- the blocks -------------------------------------------------------------------
// Front-face area roughly proportional to sloc (~35 px² per line); the two smallest
// companions (1×1, 1×2) are clamped up to a legible minimum.  Depth is constant and inert.
