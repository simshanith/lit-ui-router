...
export const sheet3 = {
  ...
  sub: `ALTITUDE 3 — ${PUBLISHED} publishable packages · ${TOOLS} tools · ${HANDOFF.turbo.distinctNames} turbo task names · one packer, many readers · every mass ${COUNTED} from diagrams/data/census-yard.json on scc Code lines — ${TOT_F} authored files and ${fmt(TOT_L)} sloc across ${massed.length} massed structures, with the task-manager inset reading the same two plates sheet 3A draws`,
  scale: 'THE MONOREPO',
  form: 'ISOMETRIC CITY',
  svg,
