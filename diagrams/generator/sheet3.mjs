...
// package.json and `turbo run ci --dry=json`.  The mise side did not move — 48 tasks,
// 37 call sites, 28 targets; only turbo's graph grew.  Non-iso: plumbing, not a district.
...
${ibox(498, 74, 126, 32, 'turbo', 'ci = 535 task nodes')}
