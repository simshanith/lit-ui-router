...
.lw-legend .lg { display: inline-flex; align-items: center; gap: 7px; font-family: var(--mono); font-size: 9.5px;
...
.lw-ctl { display: flex; gap: 10px; align-items: center; font-family: var(--mono); font-size: 9.5px;
...
.lw-info .ev pre { font-family: var(--mono); font-size: 9.5px; letter-spacing: 0; line-height: 1.35;
...
.lw-basis { font-family: var(--mono); font-size: 9.5px; letter-spacing: 0.06em; color: var(--ink-faint);
  ...
  function style(c) {
    ...
    return [
      { selector: 'node.station', style: { 'background-color': c.paper, 'background-image': 'data(sprite)',
        ...
        'text-valign': 'data(lpos)', 'text-margin-y': 'data(lgap)', 'text-wrap': 'none', 'font-family': mono, 'font-size': 12,
      ...
      { selector: 'edge.leg', style: { 'curve-style': 'straight', 'target-arrow-shape': 'triangle', 'arrow-scale': 0.8,
        ...
        'font-family': mono, 'font-size': 9.5, color: c.faint, 'text-rotation': 'autorotate',
