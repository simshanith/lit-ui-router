...
// RUST (sheet 13) and LAMPS (plate 7A) are still editorial constants keyed by badge.
...
// [rustStep, lamps (0-3 | 'e' = accent unmetered | null = no meter reads it), lampEff%]
const CHAN = new Map([
  [1, [3, 3, 92.2]], [2, [3, 3, 99.6]], [3, [1, 3, 97.7]], [4, [1, 3, 100]],
  [5, [3, 'e', null]], [6, [3, 'e', null]], [7, [3, 'e', null]], [8, [3, 3, 100]],
  [9, [1, 'e', null]], [10, [1, 1, 7.7]], [11, [1, 0, null]], [12, [3, 2, 53.2]],
  [13, [4, 0, null]], [14, [1, 0, null]], [15, [2, 1, 41.0]], [16, [2, 2, 68.5]],
  [17, [1, 2, 58.0]], [18, [1, 0, null]], [19, [1, 1, 12.2]], [20, [1, 0, null]],
  [21, [1, 0, null]], [22, [0, 0, null]], [23, [1, 0, null]], [24, [3, 0, null]],
  [25, [2, 1, 26.1]], [26, [3, 0, 0]], [27, [null, null, null]],
  [28, [0, 0, null]], [29, [0, 'e', null]], [30, [1, 0, null]],
  // №31, first drawn here: born 2026-09-01, so R0 — and plate 7A's meter predates
  // it, so its lamps are not metered rather than dark.
  [31, [0, null, null]],
]);
const chan = (n) => {
  const c = CHAN.get(n);
  if (!c) throw new Error(`plate 7B: member ${n} has no rust/lamp channel row`);
  return c;
};
...
const M = PLACED.map(([n, name, dir, dist, tier, x, y]) => {
  const c = cityOf(dir), [rust, lamps, eff] = chan(n);
...
const schedRow = ([n, name, , , , , sf, , , , rust, steam, lamps, eff]) => {
  ...
  const lampS = lamps === 'e' ? 'e2e (accent)' : lamps == null ? 'not metered (7A predates it)'
...
${txt(772, 135, 'the fifth package joins at R0, unmetered — no lamp slots to read', 'lblf')}
...
${txt(60, 132, `3 puffs (${g(1).steam} commits/90d) · 3 lamps (92% lit) · rust R3`, 'lblf')}
