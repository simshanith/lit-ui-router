...
// yet when lint builds this program, so type them explicitly. The attributes
// are what `configLoader: 'native'` needs — it imports this config through
// node instead of bundling it, and a bare JSON import throws there.
