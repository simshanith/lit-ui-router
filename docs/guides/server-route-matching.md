...
not just the destination: the <BrandLink brand="cloudflare">Cloudflare Worker</BrandLink> behind lit-ui-router.dev
...
on platforms like
<BrandLink href="https://developers.cloudflare.com/pages/configuration/serving-pages/" brand="cloudflare">Cloudflare Pages</BrandLink>
and
...
and a documented one-liner everywhere else: <BrandLink brand="nginx">nginx</BrandLink>
...
<BrandLink brand="cloudflare">Cloudflare Workers</BrandLink>
