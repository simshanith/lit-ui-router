...
The [Cloudflare Github integration](https://developers.cloudflare.com/workers/ci-cd/builds/git-integration/github-integration/) deploys documentation on push. See [www/lit-ui-router.dev/DEPLOY.md](../www/lit-ui-router.dev/DEPLOY.md) for details.
