...
// Runs after cloudflare-build.sh (bash: it runs before the install) — see docs/DEPLOY.md.
...
// dashboard: that is what the script indirection is for (see docs/DEPLOY.md).
const SITE_CONFIG = [
  '--config',
