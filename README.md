...
| `eslint-plugin-lit-ui-router`          | [![npm](https://img.shields.io/npm/v/eslint-plugin-lit-ui-router.svg)](https://npmx.dev/package/eslint-plugin-lit-ui-router)                   | [![GitHub Release](https://img.shields.io/github/v/release/simshanith/lit-ui-router?filter=eslint-plugin-lit-ui-router@*)](https://github.com/simshanith/lit-ui-router/releases/?q=eslint-plugin-lit-ui-router)                   | [![eslint-plugin-lit-ui-router published diff](https://img.shields.io/github/check-runs/simshanith/lit-ui-router/main?nameFilter=published-diff%20%28eslint-plugin-lit-ui-router%29&label=published-diff)](https://github.com/simshanith/lit-ui-router/actions/workflows/release-signals.yml?query=branch%3Amain)                   |
| `lit-ui-router-effect`                 | [![npm](https://img.shields.io/npm/v/lit-ui-router-effect.svg)](https://npmx.dev/package/lit-ui-router-effect)                                 | [![GitHub Release](https://img.shields.io/github/v/release/simshanith/lit-ui-router?filter=lit-ui-router-effect@*)](https://github.com/simshanith/lit-ui-router/releases/?q=lit-ui-router-effect)                                 | [![lit-ui-router-effect published diff](https://img.shields.io/github/check-runs/simshanith/lit-ui-router/main?nameFilter=published-diff%20%28lit-ui-router-effect%29&label=published-diff)](https://github.com/simshanith/lit-ui-router/actions/workflows/release-signals.yml?query=branch%3Amain)                                 |
| `lit-ui-router-ssr`                    | [![npm](https://img.shields.io/npm/v/lit-ui-router-ssr.svg)](https://npmx.dev/package/lit-ui-router-ssr)                                       | [![GitHub Release](https://img.shields.io/github/v/release/simshanith/lit-ui-router?filter=lit-ui-router-ssr@*)](https://github.com/simshanith/lit-ui-router/releases/?q=lit-ui-router-ssr)                                       | [![lit-ui-router-ssr published diff](https://img.shields.io/github/check-runs/simshanith/lit-ui-router/main?nameFilter=published-diff%20%28lit-ui-router-ssr%29&label=published-diff)](https://github.com/simshanith/lit-ui-router/actions/workflows/release-signals.yml?query=branch%3Amain)                                       |
